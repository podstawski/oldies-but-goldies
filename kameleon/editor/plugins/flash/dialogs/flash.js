...
(function()
{
	...
	CKEDITOR.dialog.add( 'flash', function( editor )
	{
		...
		var previewPreloader,
			previewAreaHtml = '<div>' + CKEDITOR.tools.htmlEncode( editor.lang.flash.preview ) +'<br>' +
			...
			contents : [
				{
                    ...
                    {
                      type : 'html',
                      html : '<div style="height: 450px;"><iframe frameborder="0" style="padding: 0; border: 0; width: 100%; height: 400px;" class="cke_dialog_ui_iframe" allowtransparency="true" id="km_browser_frame" src="'+CKEDITOR.getUrl( editor.plugins.link.path+'../../../ufiles.php?galeria=12')+'"></iframe></div>'
                    },
                    {
                      type : 'vbox',
        							padding : 0,
						  ...
						  
						{
							...
							[
								{
									type : 'html',
									html : '<span>' + CKEDITOR.tools.htmlEncode( editor.lang.flash.url ) + '</span>'
								},
								{
									type : 'hbox',
									widths : [ '280px', '110px' ],
									...
									[
										{
											...
											onLoad : function()
											{
												...
												updatePreview = function( src ){
													...
													document.getElementById('km_browser_frame').src=CKEDITOR.getUrl( editor.plugins.link.path+'../../../ufiles.php?galeria=12&ckpath='+src);
