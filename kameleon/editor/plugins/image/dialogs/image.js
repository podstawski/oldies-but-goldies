	...
	var imageDialog = function( editor, dialogType )
	{
		...
		return {
			...
			contents : [
				{
                  ...
                  {
                    type : 'html',
                    html : '<div style="height: 450px;"><input type="hidden" id="km_node" value="" /><input type="hidden" id="km_node_title" value="" /><iframe frameborder="0" style="padding: 0; border: 0; width: 100%; height: 400px;" class="cke_dialog_ui_iframe" allowtransparency="true" id="km_treebrowser_frame" src="'+CKEDITOR.getUrl( editor.plugins.link.path+'../../../ufiles.php?galeria=8')+'"></iframe></div>'
                  },
                  {
                    type : 'vbox',
      							padding : 0,
            ...
            // koniec wstawka Kameleona	
				...
				{
					id : 'Link',
					label : editor.lang.image.zoom, // wstawka Kameleona
					padding : 0,
					elements :
					[
						// wstawka Kameleona
            ...
            {
              type : 'html',
              html : '<div style="height: 400px"><iframe frameborder="0" style="padding: 0; border: 0; width: 100%; height: 400px;" class="cke_dialog_ui_iframe" allowtransparency="true" scrolling="no" src="'+CKEDITOR.getUrl( editor.plugins.link.path+'../../../ufiles.php?galeria=7')+'"></iframe></div>'
            }
