...
<script type="text/javascript">
	window.resizeTo(680, 535);
	ImageManager = new Object();
	document.write('<script type="text/javascript" src="lang/<?echo $IMConfig[lang]?>.js"><\/script>');
		...
		<tr>
			<td>
				<form action="editorFrame.php?img=<?=$_GET['img']?>&action=replace" target='editor' id="uploadForm" method="post" enctype="multipart/form-data">
					...
					<input type="hidden" name="dir" id="dir" value="<?=dirname($_GET['img'])?>" />
				</form>
			</td>
			<td>
