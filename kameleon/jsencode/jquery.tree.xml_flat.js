		...
		"xml_flat" : function () {
			return {
				...
				parse	: function(data, t, opts, callback) {
					...
					processor.importStylesheet(jQueryKam.tree.datastores.xml_flat.xsl);

					var result = jQueryKam((new XMLSerializer()).serializeToString(processor.transformToDocument(data)));
