...
CREATE FUNCTION longqueries(v_time double precision) RETURNS SETOF pg_stat_activity
    AS $_$
...
CREATE TABLE kraje (
    kr_id integer,
    kr_parent integer,
    kr_nazwa character varying(200),
    kr_crm_id integer,
    kr_peimp_id integer,
    kr_atrybuty smallint,
    kr_d_create integer,
    kr_u_create integer,
    kr_d_update integer,
    kr_u_update integer
...
CREATE TABLE polska (
    ...
    po_peimp_id integer,
    po_miasto character varying(100),
    po_atrybuty smallint,
    po_d_create integer,
    po_u_create integer,
    po_d_update integer,
    po_u_update integer,
...
CREATE TABLE pracodawca (
    ...
    pr_po_woj integer,
    pr_status character varying(10) DEFAULT 'NOWA'::character varying,
    pr_nip character varying(15),
    pr_adres character varying(100),
    pr_kod character varying(50),
    pr_miasto character varying(80),
    pr_email character varying(100),
    pr_telefon character varying(50),
    pr_faks character varying(50),
    pr_zamawiajacy_imie character varying(100),
    pr_nazwa character varying(100),
    pr_adres_dom character varying(20),
    pr_adres_lokal character varying(20),
    pr_uwagi text,
    pr_www character varying(100),
    pr_regon character varying(15),
    pr_d_create integer,
    pr_u_create integer,
    pr_d_update integer,
    pr_u_update integer,
    pr_typ integer DEFAULT 1,
    pr_stanowisko character varying(200),
    pr_branza character varying(200),
    pr_lokalizacja_pracy character varying(200),
    pr_zakres_obowiazkow text,
    pr_wymagania text,
    pr_rodzaj_umowy character varying(200),
    pr_wynagrodzenie_netto character varying(200),
    pr_liczba_wolnych_miejsc character varying(200),
    pr_wymiar_czasu_pracy character varying(200),
    pr_okres_waznosci_dni integer,
    pr_numer character varying(100),
    pr_kr_id integer
);
...
CREATE SEQUENCE pracodawca_pr_id_seq
    INCREMENT BY 1
    NO MAXVALUE
    NO MINVALUE
    CACHE 1;
...
ALTER SEQUENCE pracodawca_pr_id_seq OWNED BY pracodawca.pr_id;
...
CREATE TABLE pracownik (
    pr_id integer NOT NULL,
    pr_nazwisko character varying(50),
    pr_imie character varying(50),
    pr_data_urodzenia date,
    pr_adres character varying(100),
    pr_kod character varying(50),
    pr_miasto character varying(80),
    pr_email character varying(100),
    pr_telefon character varying(50),
    pr_telefon_gsm character varying(50),
    pr_angielski integer,
    pr_niemiecki integer,
    pr_rosyjski integer,
    pr_francuski integer,
    pr_inne_nazwa character varying(50),
    pr_inne integer,
    pr_stanowisko character varying(50),
    pr_branza character varying(50),
    pr_system_pracy integer,
    pr_etat integer,
    pr_miejsce_pracy character varying(50),
    pr_wynagrodzenie_netto character varying(50),
    pr_d_create integer,
    pr_u_create integer,
    pr_d_update integer,
    pr_u_update integer,
...
CREATE TABLE pracownik_cv (
    pc_id integer NOT NULL,
    pc_pr_id integer,
    pc_nazwa character varying(50),
    pc_plik character varying(200)
);
...
CREATE SEQUENCE pracownik_cv_pc_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MAXVALUE
    NO MINVALUE
...
ALTER SEQUENCE pracownik_cv_pc_id_seq OWNED BY pracownik_cv.pc_id;


--
--

CREATE TABLE pracownik_komputer (
    pk_id integer NOT NULL,
    pk_pr_id integer,
    pk_program character varying(50),
    pk_poziom_znajomosci integer
);
...
CREATE SEQUENCE pracownik_komputer_pk_id_seq
    INCREMENT BY 1
    NO MAXVALUE
    NO MINVALUE
    CACHE 1;
...
ALTER SEQUENCE pracownik_komputer_pk_id_seq OWNED BY pracownik_komputer.pk_id;


--
--

CREATE SEQUENCE pracownik_pr_id_seq
    INCREMENT BY 1
    NO MAXVALUE
    NO MINVALUE
    CACHE 1;
...
ALTER SEQUENCE pracownik_pr_id_seq OWNED BY pracownik.pr_id;


--
--

CREATE TABLE pracownik_praca (
    pp_id integer NOT NULL,
    pp_pr_id integer,
    pp_okres_zatrudnienia character varying(50),
    pp_nazwa_pracodawcy character varying(50),
    pp_miejsce_pracy character varying(50),
    pp_branza character varying(50),
    pp_stanowisko character varying(50),
    pp_zakres_obowiazkow character varying(50)
);
...
CREATE SEQUENCE pracownik_praca_pp_id_seq
    INCREMENT BY 1
    NO MAXVALUE
    NO MINVALUE
    CACHE 1;
...
ALTER SEQUENCE pracownik_praca_pp_id_seq OWNED BY pracownik_praca.pp_id;


--
--

CREATE TABLE pracownik_szkolenie (
    ps_id integer NOT NULL,
    ps_pr_id integer,
    ps_temat character varying(50),
    ps_czas_trwania character varying(50),
    ps_nazwa_organizatora_szkolenia character varying(50),
    ps_uzyskany_certyfikat_zawodowy character varying(50)
);
...
CREATE SEQUENCE pracownik_szkolenie_ps_id_seq
    INCREMENT BY 1
    NO MAXVALUE
    NO MINVALUE
    CACHE 1;
...
ALTER SEQUENCE pracownik_szkolenie_ps_id_seq OWNED BY pracownik_szkolenie.ps_id;


--
--

CREATE TABLE pracownik_wyksztalcenie (
    pw_id integer NOT NULL,
    pw_pr_id integer,
    pw_okres_nauki character varying(50),
    pw_nazwa_szkoly character varying(50),
    pw_wydzial_i_specjalizacja character varying(50),
    pw_tytul_zawodowy character varying(50)
);
...
CREATE SEQUENCE pracownik_wyksztalcenie_pw_id_seq
    INCREMENT BY 1
    NO MAXVALUE
    NO MINVALUE
    CACHE 1;
...
ALTER SEQUENCE pracownik_wyksztalcenie_pw_id_seq OWNED BY pracownik_wyksztalcenie.pw_id;
...
ALTER TABLE pracodawca ALTER COLUMN pr_id SET DEFAULT nextval('pracodawca_pr_id_seq'::regclass);


--
--

ALTER TABLE pracownik ALTER COLUMN pr_id SET DEFAULT nextval('pracownik_pr_id_seq'::regclass);


--
--

ALTER TABLE pracownik_cv ALTER COLUMN pc_id SET DEFAULT nextval('pracownik_cv_pc_id_seq'::regclass);


--
--

ALTER TABLE pracownik_komputer ALTER COLUMN pk_id SET DEFAULT nextval('pracownik_komputer_pk_id_seq'::regclass);


--
--

ALTER TABLE pracownik_praca ALTER COLUMN pp_id SET DEFAULT nextval('pracownik_praca_pp_id_seq'::regclass);


--
--

ALTER TABLE pracownik_szkolenie ALTER COLUMN ps_id SET DEFAULT nextval('pracownik_szkolenie_ps_id_seq'::regclass);


--
--

ALTER TABLE pracownik_wyksztalcenie ALTER COLUMN pw_id SET DEFAULT nextval('pracownik_wyksztalcenie_pw_id_seq'::regclass);
