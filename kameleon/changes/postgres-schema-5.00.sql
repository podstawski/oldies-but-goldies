...
CREATE TABLE acl_core (
    ac_id integer
);

CREATE TABLE acl_group (
    ag_id integer NOT NULL,
    ag_name character varying(64),
    ag_system integer
);

CREATE SEQUENCE acl_group_ag_id_seq
    INCREMENT BY 1
    NO MAXVALUE
    NO MINVALUE
    CACHE 1;

ALTER SEQUENCE acl_group_ag_id_seq OWNED BY acl_group.ag_id;

CREATE TABLE acl_matrix (
    am_id integer NOT NULL,
    am_resource integer,
    am_resource_id character varying(64),
    am_user integer,
    am_group integer,
    am_right integer,
    am_grant smallint DEFAULT 1,
    am_system integer
);

CREATE SEQUENCE acl_matrix_am_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MAXVALUE
    NO MINVALUE
...
ALTER SEQUENCE acl_matrix_am_id_seq OWNED BY acl_matrix.am_id;

CREATE TABLE acl_resource (
    ar_id integer NOT NULL,
    ar_name character varying(40),
    ar_system integer
);

CREATE SEQUENCE acl_resource_ar_id_seq
    INCREMENT BY 1
    NO MAXVALUE
    NO MINVALUE
    CACHE 1;

ALTER SEQUENCE acl_resource_ar_id_seq OWNED BY acl_resource.ar_id;
...
CREATE SEQUENCE acl_right_ar_id_seq
    INCREMENT BY 1
    NO MAXVALUE
    NO MINVALUE
    CACHE 1;

ALTER SEQUENCE acl_right_ar_id_seq OWNED BY acl_right.ar_id;

CREATE TABLE acl_system (
    as_id integer NOT NULL,
    as_name character varying(40) NOT NULL,
    as_last_save integer DEFAULT 0,
    as_last_update integer
);

CREATE SEQUENCE acl_system_as_id_seq
    INCREMENT BY 1
    NO MAXVALUE
    NO MINVALUE
    CACHE 1;

ALTER SEQUENCE acl_system_as_id_seq OWNED BY acl_system.as_id;

CREATE TABLE acl_update (
    au_id integer NOT NULL,
    au_file character varying(100),
    au_time integer
);

CREATE SEQUENCE acl_update_au_id_seq
    INCREMENT BY 1
    NO MAXVALUE
    NO MINVALUE
    CACHE 1;

ALTER SEQUENCE acl_update_au_id_seq OWNED BY acl_update.au_id;

CREATE TABLE acl_user (
    au_id integer NOT NULL,
    au_name character varying(256),
    au_login character varying(256),
    au_pass character varying(64),
    au_pass2 character varying(64)
);

CREATE SEQUENCE acl_user_au_id_seq
    INCREMENT BY 1
    NO MAXVALUE
    NO MINVALUE
    CACHE 1;

ALTER SEQUENCE acl_user_au_id_seq OWNED BY acl_user.au_id;

CREATE TABLE acl_user_group (
    aug_id integer NOT NULL,
    aug_user integer,
    aug_group integer
);

CREATE SEQUENCE acl_user_group_aug_id_seq
    INCREMENT BY 1
    NO MAXVALUE
    NO MINVALUE
    CACHE 1;

ALTER SEQUENCE acl_user_group_aug_id_seq OWNED BY acl_user_group.aug_id;
...
ALTER TABLE acl_group ALTER COLUMN ag_id SET DEFAULT nextval('acl_group_ag_id_seq'::regclass);

ALTER TABLE acl_matrix ALTER COLUMN am_id SET DEFAULT nextval('acl_matrix_am_id_seq'::regclass);

ALTER TABLE acl_resource ALTER COLUMN ar_id SET DEFAULT nextval('acl_resource_ar_id_seq'::regclass);

ALTER TABLE acl_right ALTER COLUMN ar_id SET DEFAULT nextval('acl_right_ar_id_seq'::regclass);

ALTER TABLE acl_system ALTER COLUMN as_id SET DEFAULT nextval('acl_system_as_id_seq'::regclass);

ALTER TABLE acl_update ALTER COLUMN au_id SET DEFAULT nextval('acl_update_au_id_seq'::regclass);

ALTER TABLE acl_user ALTER COLUMN au_id SET DEFAULT nextval('acl_user_au_id_seq'::regclass);

ALTER TABLE acl_user_group ALTER COLUMN aug_id SET DEFAULT nextval('acl_user_group_aug_id_seq'::regclass);
...
ALTER TABLE ONLY acl_group
    ADD CONSTRAINT acl_group_pkey PRIMARY KEY (ag_id);

ALTER TABLE ONLY acl_matrix
    ADD CONSTRAINT acl_matrix_pkey PRIMARY KEY (am_id);

ALTER TABLE ONLY acl_resource
    ADD CONSTRAINT acl_resource_pkey PRIMARY KEY (ar_id);

ALTER TABLE ONLY acl_right
    ADD CONSTRAINT acl_right_pkey PRIMARY KEY (ar_id);

ALTER TABLE ONLY acl_system
    ADD CONSTRAINT acl_system_as_name_key UNIQUE (as_name);

ALTER TABLE ONLY acl_system
    ADD CONSTRAINT acl_system_pkey PRIMARY KEY (as_id);

ALTER TABLE ONLY acl_user_group
    ADD CONSTRAINT acl_user_group_pkey PRIMARY KEY (aug_id);

ALTER TABLE ONLY acl_user
    ADD CONSTRAINT acl_user_pkey PRIMARY KEY (au_id);
...
CREATE UNIQUE INDEX acl_user_login ON acl_user USING btree (au_login);
...
ALTER TABLE ONLY acl_group
    ADD CONSTRAINT acl_group_ag_system_fkey FOREIGN KEY (ag_system) REFERENCES acl_system(as_id);

ALTER TABLE ONLY acl_matrix
    ADD CONSTRAINT acl_matrix_am_group_fkey FOREIGN KEY (am_group) REFERENCES acl_group(ag_id);

ALTER TABLE ONLY acl_matrix
    ADD CONSTRAINT acl_matrix_am_resource_fkey FOREIGN KEY (am_resource) REFERENCES acl_resource(ar_id);

ALTER TABLE ONLY acl_matrix
    ADD CONSTRAINT acl_matrix_am_right_fkey FOREIGN KEY (am_right) REFERENCES acl_right(ar_id);

ALTER TABLE ONLY acl_matrix
    ADD CONSTRAINT acl_matrix_am_user_fkey FOREIGN KEY (am_user) REFERENCES acl_user(au_id);

ALTER TABLE ONLY acl_resource
    ADD CONSTRAINT acl_resource_ar_system_fkey FOREIGN KEY (ar_system) REFERENCES acl_system(as_id);

ALTER TABLE ONLY acl_right
    ADD CONSTRAINT acl_right_ar_system_fkey FOREIGN KEY (ar_system) REFERENCES acl_system(as_id);

ALTER TABLE ONLY acl_user_group
    ADD CONSTRAINT acl_user_group_aug_group_fkey FOREIGN KEY (aug_group) REFERENCES acl_group(ag_id);

ALTER TABLE ONLY acl_user_group
    ADD CONSTRAINT acl_user_group_aug_user_fkey FOREIGN KEY (aug_user) REFERENCES acl_user(au_id);
