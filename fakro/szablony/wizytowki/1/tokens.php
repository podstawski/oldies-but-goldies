...
/**/
    ...
    break;
		...
		case "SID_GOOGLE_ANALYTICS":
			if($lang == 'ca' && $KAMELEON_MODE == 0) {
				$re = "<script src=\"http://www.google-analytics.com/urchin.js\" type=\"text/javascript\"></script>
					<script type=\"text/javascript\">
						_uacct = \"UA-973963-7\";
						urchinTracker();
					</script>";
				}
			if($lang == 'us' && $KAMELEON_MODE == 0) {
				$re = "<script src=\"http://www.google-analytics.com/urchin.js\" type=\"text/javascript\"></script>
					<script type=\"text/javascript\">
						_uacct = \"UA-973963-8\";
						urchinTracker();
