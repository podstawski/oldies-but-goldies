...
function popup_img(url, size_w, size_h, scroll) {
	...
	msg.document.write("<IMG SRC='"+url+"' ALT='ZAMKNIJ' BORDER='0' onclick='window.close()' ");
...
function popup_mov(url, size_w, size_h, scroll) {
	new_add_w	=	10;
	new_add_h	=	100;
...
//	msg.document.close();
	...
	msg.document.write("</HEAD>\n");
	msg.document.write("<BODY BGCOLOR=White style='margin: 0; font-size: 11px; font-family: verdana; vertical-align: center; text-align: center;'>\n");
	msg.document.write("<EMBED src='"+url+"' width='"+start_size_w+"' height='"+start_size_h+"' autoplay=yes></EMBED>");
//	msg.document.write("<p>Zamknij okno</p>\n");
	msg.document.write("</BODY></HTML>\n");
	msg.focus();
};
...
function popup_img2(text,url,href ,size_w, size_h, scroll) {
	new_add_w	=	10;
	new_add_h	=	80;
	...
	msg.document.write("</HEAD>\n");
	msg.document.write("<BODY BGCOLOR=White style='margin: 0; font-size: 11px; font-family: verdana; vertical-align: center; text-align: center;'>\n");
	msg.document.write("<table><tr><td>");
	
	msg.document.write("<a href="+href+" id='inlink'><IMG SRC='"+url+"' ALT='' BORDER='0'  style='cursor: hand;'");
	if (size_w==null && size_h==null) msg.document.write(" onload='popup_resize(window,this)' ");
	msg.document.write("onClick='window.close();'></a></td></tr>");
	msg.document.write("<tr><td style='font-size:10px;color:#666;text-align:center;'>"+text+"</td></tr></table>");
	msg.document.write("</BODY></HTML>\n");
	if (msg.document.getElementById('inlink') != null)
		msg.document.getElementById('inlink').target = window.name;
	if (msg.document.getElementById('inlink2') != null)
		msg.document.getElementById('inlink2').target = window.name;
	msg.document.close();
	msg.focus();
	
};
function galeriaOnclick(obj,fot,text,href)

{
		
           popup_img2(text,fot,href);
           obj.onclick=null;
           return false;
