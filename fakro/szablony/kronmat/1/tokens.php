...
//			if (!strlen($WEBPAGE->class)) 
		...
		case "WEBPAGE_JS_JQUERY":
			return "
				<script src=\"$IMAGES/jquery.min.js\" type=\"text/javascript\"></script>
				<script src=\"$IMAGES/jquery_menu.js\" type=\"text/javascript\"></script>
				";
		break; 
...
/**/
		...
		case "WEBPAGE_LANG":
			if(strstr($lang,'k')) $site='k_img';
			if(strstr($lang,'o')) $site='o_img';
			if(strstr($lang,'b')) $site='b_img';
			if(strstr($lang,'p')) $site='p_img';
			if(strstr($lang,'t')) $site='t_img';
			if(strstr($lang,'f')) $site='t_img';
			
			return $site;
		
		case "WEBPAGE_TEXTSTYLE_CSS":
			if(strstr($lang,'k')) $site='k';
			if(strstr($lang,'o')) $site='o';
			if(strstr($lang,'b')) $site='b';
			if(strstr($lang,'p')) $site='p';
			if(strstr($lang,'t')) $site='t';
			if(strstr($lang,'f')) $site='f';
			
			if($site=='k') {
				$re = "<link href=\"$IMAGES/textstyle_k.css\" rel=\"stylesheet\" type=\"text/css\">";
				$re .= "<link href=\"$IMAGES/szablon_k.css\" rel=\"stylesheet\" type=\"text/css\">";
				}
			if($site=='o') {
				$re = "<link href=\"$IMAGES/textstyle_o.css\" rel=\"stylesheet\" type=\"text/css\">";
				$re .= "<link href=\"$IMAGES/szablon_o.css\" rel=\"stylesheet\" type=\"text/css\">";
				}
			if($site=='b') {
				$re = "<link href=\"$IMAGES/textstyle_b.css\" rel=\"stylesheet\" type=\"text/css\">";
				$re .= "<link href=\"$IMAGES/szablon_b.css\" rel=\"stylesheet\" type=\"text/css\">";
				}
			if($site=='p') {
				$re = "<link href=\"$IMAGES/textstyle_p.css\" rel=\"stylesheet\" type=\"text/css\">";
				$re .= "<link href=\"$IMAGES/szablon_p.css\" rel=\"stylesheet\" type=\"text/css\">";
				}
			if($site=='t') {
				$re = "<link href=\"$IMAGES/textstyle_t.css\" rel=\"stylesheet\" type=\"text/css\">";
				$re .= "<link href=\"$IMAGES/szablon_t.css\" rel=\"stylesheet\" type=\"text/css\">";
				}
			if($site=='f') {
				$re = "<link href=\"$IMAGES/textstyle_f.css\" rel=\"stylesheet\" type=\"text/css\">";
				$re .= "<link href=\"$IMAGES/szablon_f.css\" rel=\"stylesheet\" type=\"text/css\">";
				}
			$re .=" ";
