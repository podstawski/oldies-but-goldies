...
for ($g=0;$g<$gr_res->recordCount();$g++)
{
	...
	$form.=" wy³±cz grupê <b>$c_email2</b> ($ile_osob)<br>";
}
...
<br><br>LUB PROSZÊ WKLEIÆ ADRESY:<br>
...
<script>
	...
	{
		if (confirm("Czy jestes pewny, ze chcesz wys³aæ do tylu osób ?"))
		{
...
*/
	...
	if ($mailing_action==3)
	{
		...
		$sysinfo="Mail zosta³ wys³any do ".count($mailbcc)." osób.";
	}
