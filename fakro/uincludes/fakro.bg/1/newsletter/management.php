...
for ($g=0;$g<$gr_res->recordCount();$g++)
{
	...
	$form.=" wyГБcz grupъ <b>$c_email2</b> ($ile_osob)<br>";
}
...
<br><br>LUB PROSZЪ WKLEIЦ ADRESY:<br>
...
<script>
	...
	{
		if (confirm("Czy jestes pewny, ze chcesz wysГaц do tylu osѓb ?"))
		{
...
*/
	...
	if ($mailing_action==3)
	{
		...
		$sysinfo="Mail zostaГ wysГany do ".count($mailbcc)." osѓb.";
	}
	...
	$fromaddr="fakro@news.fakro.info";
