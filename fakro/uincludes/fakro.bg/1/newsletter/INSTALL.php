<?
	...
	if ($cos==0)
	{
		...
		newsletter_action($page,$page,$page,'ZapiszLink',$webtd."&menu_id=$menu_id&pri=1&alt=WysyГka");
		...
		newsletter_action($new_page_1,$new_page_1,$new_page_1,'ZapiszMenu',$new_td_1."&menu_id=$submenu:$INSTALL_NAME+wysyГka");
		...
		newsletter_todo($WEBTD,"Proszъ siъ upewniц czy zainstalowano moduГ <B>api</B>.");
		newsletter_todo($WEBTD,"Proszъ sprawdziц czy w pliku <b>$SZABLON_PATH/const.php</b> znajduje siъ wpis <br>&nbsp;&nbsp;<b>\$C_MODULES=array('api');</b>");
		newsletter_todo($WEBTD,"Proszъ sprawdziц czy w pliku <b>$SZABLON_PATH/const.php</b> znajduje siъ wpis <br>&nbsp;&nbsp;<b>\$CONST_MORE_TOKENS=array('newsletter_tokens'=>'newsletter_tokens.php');</b>");
		...
		newsletter_todo($WEBTD,"Proszъ sprawdziц czy w pliku <b>$SZABLON_PATH/const.php</b> znajduje siъ wpis <b>
