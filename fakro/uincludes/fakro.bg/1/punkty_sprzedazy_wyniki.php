<?
	...
	if (strlen($szukaj[miejsce])) {
		$cond.= " AND (ps_miasto ~* '".addslashes(stripslashes(mb_strtoupper($szukaj['miejsce'], "ISO-8859-2")))."'";
...
//	$fakrodb->debug=1;
	...
	for ($i=0; $i < $res->RecordCount(); $i++)
	{
		...
		if($ps_ma_okno) $ico_okno = '<img src="'.$IMAGES.'/ico_gdzie_kupic_okno.gif" width="15" height="15" title="Punkt sprzedaПy posiada okna ekspozycyjne" alt="Punkt sprzedaПy posiada okna ekspozycyjne" border="0">';
		if($ps_ma_schody) $ico_schody = '<img src="'.$IMAGES.'/ico_gdzie_kupic_schody.gif" width="15" height="15" title="Punkt sprzedaПy posiada schody ekspozycyjne" alt="Punkt sprzedaПy posiada schody ekspozycyjne" border="0">';
	...
	echo '<img src="'.$IMAGES.'/ico_gdzie_kupic_okno.gif" width="15" height="15" title="Punkt sprzedaПy posiada okna ekspozycyjne" alt="Punkt sprzedaПy posiada okna ekspozycyjne" border="0"> Punkt sprzedaПy posiada okna ekspozycyjne';
	echo '<br>';
	echo '<img src="'.$IMAGES.'/ico_gdzie_kupic_schody.gif" width="15" height="15" title="Punkt sprzedaПy posiada schody ekspozycyjne" alt="Punkt sprzedaПy posiada schody ekspozycyjne" border="0"> Punkt sprzedaПy posiada schody ekspozycyjne';
