...
<?
	...
	echo '<br><br>
	<a href="javascript: void(0);" onclick="history.go(-1);return false;">Powrѓt do listy</a>
	<br><br>
	...
	<thead>
	<tr>
		<td>powierzchnia uПytkowa</td>
		<td>powierzchnia zabudowy</td>
		<td>kБt nachylenia dachu</td>
		<td>wysokoЖц budynku</td>
		<td>minimalne wymiary dziaГki</td>
	</tr>
	<tr>
		<td>[m<sup>2</sup>]</td>
		<td>[m<sup>2</sup>]</td>
