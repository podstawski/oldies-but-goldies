...
<tr>
	<td align="right">wielkoЖц domu </td>
	<td>
	<select name="form[pu]">
		...
		<option value="3" '.((htmlspecialchars($form[pu])==3)?"selected":"").'>PowyПej 150 m2</option>
	</select>
	</td>
</tr>
<!---
...
if($form[pole] == "szukaj") {
	...
	if(!$res->RecordCount()) {
		echo '<br><br><div align="center"><strong>Nie znaleziono Пadnych wpisѓw o podanych kryteriach lub lista jest pusta.</strong></div>';
		return;
		}
	...
	<TR>
		...
		<TD align="center">pow. uПytkowa</TD>
...
if($form[view] == 1) {
	...
	<tr>
		<td align="right"><strong>Powierzchnia uПytkowa:</strong></td>
	...
	<tr>
		<td align="right"><strong>KБt nachylenia dachu:</strong></td>
		<td>'.$projekt_k_nachylenia.' &ordm;</td>
	</tr>
	<tr>
		<td align="right"><strong>WysokoЖц budynku:</strong></td>
		<td>'.$projekt_w_budynku.' m<sup>2</sup></td>
	</tr>
	<tr>
		<td align="right"><strong>Minimalne wymiary dziaГki:</strong></td>
		<td>'.$projekt_p_dzialki.' m<sup>2</sup></td>
	</tr>
	<!---  --->
	<tr>
		<td align="right"><strong>Іciany:</strong></td>
	...
	<tr>
		<td align="right"><strong>GaraП:</strong></td>
