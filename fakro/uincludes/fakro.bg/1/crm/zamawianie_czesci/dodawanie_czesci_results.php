...
if($id_bp_okna) {
										...
										if($map_access_www == '1') {
											...
											foreach($_czesci as $_czesci_1) {
												if($_czesci_1['nr_explozyjny'] == $v['nr_explozyjny']) {
													...
													#$maps .= "<a href=\'javascript:void(0);\' onClick=\'add(".$v['nr_explozyjny'].");\' style=\'color:#000000;\'><strong>Zamѓw czъЖц</strong></a>";
													$maps .= "<a href=\'javascript:void(0);\' onClick=add(\'".$v['nr_explozyjny']."\');cClick();show_lista(); style=\'color:#000000;\'><strong>Zamѓw czъЖц</strong></a>";
	...
	$showInfoDiv = false;
	$content = 'Przepraszamy produkt niedostъpny.<br>Prosimy o kontakt z dziaГem serwisu <a href="mailto:serwis@fakro.pl">serwis@fakro.pl</a>';
...
Kliknij na rysunku, aby wybraц czъЖci do zamѓwienia:
...
<tr>
	...
	<? if(strlen($_SESSION['nazwa_nr3']) || strlen($_SESSION['nazwa_nr4'])) echo "- ".$_SESSION['nazwa_nr3']." - ".$_SESSION['nazwa_nr4']; ?>
...
<tr>
	...
	<img src="<?=$_path?>js/jscalendar/img.gif" id="data_nabycia_towaru_b" style="cursor: pointer; border: 1px solid green;" title="podglЙd kalendarza" onmouseover="this.style.background='green';" onmouseout="this.style.background=''" />
	<script type="text/javascript">
		Calendar.setup({
...
<tr>
	<td valign="top" id="data_montazu_label">Data montaПu produktu <span id="data_montazu_gwiazdka" style="color:Red;">*</span>:</td>
	<td><input type="text" name="data_montazu[]" id="data_montazu" value="" style="width:100px" readonly>
	<img src="<?=$_path?>js/jscalendar/img.gif" id="data_montazu_b" style="cursor: pointer; border: 1px solid green;" title="podglЙd kalendarza" onmouseover="this.style.background='green';" onmouseout="this.style.background=''" />
	<script type="text/javascript">
		Calendar.setup({
...
<tr>
	...
	<input type="submit" class="button" value="PrzejdМ do podsumowania" onclick="el('userAction').value='summary';return validate();" />
	</td>
</tr>
</form>
</tbody>
