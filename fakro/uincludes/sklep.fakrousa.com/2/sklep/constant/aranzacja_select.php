...
//08.06.2006, 10:30, autor: Robson, modyfikacja selectow aby by³o równie¿ bez $typ i wtedy tylko jeden select

//by Robson
$selectKolStyle="style=\"width:150px;\"";
...
$sel_kolor = "<select $selectKolStyle name=\"kolor\" id=\"kol\" onChange=\"wSetSelect(this,document.getElementById('typ'),'typ')\"><option>kolorów</option>";
$sel_typ = "<select $selectTypStyle name=\"typ\" id=\"typ\" onChange=\"wSetSelect(document.getElementById('kol'),this,'kolor')\"><option>typów</option>";
...
$ret.= "</td>";
$ret.= "<td>";
$ret.= "<img onClick=\"validateSel()\" style=\"cursor:pointer\" src=\"".$IMAGES."/sklep/sort.gif\">";
$ret.= "</td>";
$ret.= "</tr>";
$ret.= "</table></form>";
echo $ret;
...
<script>
	...
	function wSetSelect(obj1,obj2,co)
	{
		...
		{
			wResetSelect(document.getElementById('typ'),'typów');
