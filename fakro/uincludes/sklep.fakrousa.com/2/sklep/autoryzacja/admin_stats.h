...
//		pg_exec($db,$sql);		
		...
		include("$SKLEP_INCLUDE_PATH/navifun.h");
...
//			$adodb->debug=0;
			$total_info = "£±czny czas dla: ".$szukaj[user]." - ".date("H:i:s",$suma - 3600)."<br>";
		}
		...
		<TR class=\"tabletr\" bgcolor=\"#EAEAF4\">
			<td class=\"tabletd\">U¿ytkownik:</td>
...
//		$adodb->debug=0;		
		...
		<TR class=\"tabletr\" bgcolor=\"#EAEAF4\">
			...
			<TH class=\"tabletd\">U¿ytkownik</TH>
