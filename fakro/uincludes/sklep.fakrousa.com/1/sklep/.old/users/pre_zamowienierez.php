...
//colspan=\"$colspan\"
	...
	<tr>
	<td colspan=\"3\" nowrap><img src=\"$SKLEP_IMAGES/spacer.gif\" width=\"35px\" align=\"left\">
	".sysmsg("Order number","system")." <INPUT TYPE=\"text\" id=\"ordernmb\" NAME=\"list[order_number]\" value=\"\"></td>
	<td class=\"c4\" align=\"right\" colspan=\"$colspan\">
	<INPUT TYPE=\"submit\" value=\"".sysmsg("Submit order","system")."\">
	<INPUT TYPE=\"hidden\" NAME=\"list[data]\" value=\"$ko_rez_data\">
