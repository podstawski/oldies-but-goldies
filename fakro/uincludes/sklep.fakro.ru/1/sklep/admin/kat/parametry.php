<?
	...
	<option value=\"\">".sysmsg('None','kat')."</option>
	$options
	</select>";
//	<option value=\"0\">Przyznane rabaty</option>
	...
	$foto_add = " 
		<TR>
			...
			<TD class=\"c4\"><INPUT TYPE=\"text\" id=foto NAME=\"form[ka_foto_m]\" value=\"$ka_foto_m\" style=\"width:350px\">
					<img src=$SKLEP_IMAGES/sb/i_image_n.gif align=absmiddle 
						...
						border=0 alt='".sysmsg('Insert or modify a picture','admin')."' width=23 height=22>			
			</TD>
		</TR>
		<TR>
			<TD class=\"c2\">".sysmsg("Big photo","admin").":</TD>
			<TD class=\"c4\"><INPUT TYPE=\"text\" id=foto2 NAME=\"form[ka_foto_d]\" value=\"$ka_foto_d\" style=\"width:350px\">
					<img src=$SKLEP_IMAGES/sb/i_image_n.gif align=absmiddle 
	...
	<tbody>
	<TR>
		<Td class=\"c2\">".sysmsg('Name','kat')."</Td>
		<Td class=\"c4\"><INPUT TYPE=\"text\" NAME=\"form[ka_nazwa]\" value=\"$ka_nazwa\"></Td>
	</TR>
	<TR>
		<Td class=\"c2\">".sysmsg('Parent category','kat')."</Td>
		<Td class=\"c4\">$kategorie</Td>
	</TR>	
	$foto_add
	<TR>
		<TD class=\"c4\" colspan=2>".sysmsg('Short description','kat').":<br>
		<textarea NAME=\"form[ka_opis_m_$lang]\" style=\"width:100%; height:60px\">$opis</textarea></TD>
	</TR>
	<tbody>
	<tfoot>
	<TR>
		<TD class=\"c4\" colspan=2><INPUT TYPE=\"submit\" class=\"button\" value=\"".sysmsg("Save","admin")."\"></TD></TR>
	</tfoot>
	</table>
	";
