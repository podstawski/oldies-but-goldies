<?
	...
	if ($ctx_cena)
		$cn = "<th sort=\"ts_cena\">".sysmsg("Price netto","cart")."</th>";

	$table ="
	$navi
	<table id=\"wydruk\" class=\"list_table\">
	<TR>		
		<th sort=\"ts_pri\" title=\"".sysmsg('Sort by','admin')."\">".sysmsg("Lp.","system")."</th>
		<th sort=\"to_indeks\" nowrap>$i_wymiar</th>
		<th sort=\"to_nazwa\">$n_wymiar</th>
		$cn
		<th>".sysmsg("Actions","system")."</th></tr>";
