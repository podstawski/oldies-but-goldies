...
if (!function_exists("iso2win"))
{
	...
	{
		$str=ereg_replace("Ё","Ѕ",$str);
		$str=ereg_replace("І","",$str);
		$str=ereg_replace("Ќ","",$str);
		$str=ereg_replace("Б","Й",$str);
...
$fc = "[INFO]
\"1.05\",3,$kodowanie,\"Gammanet - Wirtualny Magazyn\",\"$podmiot\",\"$podmiot\",\"$podmiot\",,,,,\"$magazyn\",\"GГѓwny\",\"Magazyn gГѓwny\",,0,,,\"Szef\",$d,\"Polska\",\"PL\",,0
