function validateForm(obj,lang)
{
	switch (lang) {
		case 'd':
			txt_rbcb = "Bitte fќllen Sie alle felder aus!";
			txt_brak = "Bitte fќllen Sie alle felder aus!";
			txt_mail = "Dein e-mail ist nicht korrekt!";
		break;
		
		default: 
			txt_rbcb = "proszъ zaznaczyц kwadracik !";
			txt_brak = "proszъ uzupeГniц dane !";
			txt_mail = "nieprawidГowy adres email !";
	}
