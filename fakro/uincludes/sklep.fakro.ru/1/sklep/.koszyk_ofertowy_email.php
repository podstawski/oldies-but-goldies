...
*/
	...
	{
		$usun = "<img src=\"$UIMAGES/autoryzacja/i_nie.gif\" alt=\"Usuё adres\" onClick=\"usunAdres($i)\">";
		$maile_tab.= "
	...
	{
		$usun = "<img src=\"$UIMAGES/autoryzacja/i_nie.gif\" alt=\"Usuё region\" onClick=\"usunRegion($i)\">";
		$regiony_tab.= "
		<FORM METHOD=POST ACTION=\"$self\">
		<INPUT TYPE=\"hidden\" name=\"do_action\" value=\"1\">
		<TR>
...
<script>
	...
	{
		if (!confirm('Na pewno usunБц ten adres ?')) return;
	...
	{
		if (!confirm('Na pewno usunБц ten region ?')) return;
