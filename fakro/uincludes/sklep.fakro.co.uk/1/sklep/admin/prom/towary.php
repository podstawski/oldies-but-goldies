<?
	...
	<TR>
		<TD class=\"c2\" colspan=\"2\"><INPUT onClick=\"indxOnClick_$sid(this)\" onBlur=\"indxOnBlur_$sid(this)\" TYPE=\"text\" NAME=\"form[dodaj]\" value=\"$indx\"></TD>
		<TD class=\"c4\"><INPUT TYPE=\"submit\" value=\"Dodaj towar\"></TD>
	</TR>	
	</FORM>	
	</TABLE>
...
<script>
	...
	{
		if (confirm('Na pewno usun±æ ten towar z promocji ?'))
		{
