<?
	...
	for ($i=0; $i < $res->RecordCount(); $i++)
	{
		...
		$cena=u_cena($zp_cena);
		echo "<td><a href=\"javascript:zampoz_zmiana($zp_id,'zp_ilosc','Podaj ilo¶æ w $to_jm',$zp_ilosc)\">| &nbsp; $zp_ilosc $to_jm</a>";
		echo "<td><a href=\"javascript:zampoz_zmiana($zp_id,'zp_cena','Podaj cenê netto',$zp_cena)\">| &nbsp; za $cena</a>";
	}
	echo "</table>";
