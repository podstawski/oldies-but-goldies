...
// FAKRO zamiana byl problem z dostaniem sie do odpowienich danych
		...
		{
			if($za_notpola) $colspan = count(explode(',',$za_notpola));
			$ret.="<tr>";
			$ret.="<td colspan=\"".(7-$colspan)."\"><br><br></td>";
			$ret.="</tr>";
			
			$ret.="<tr class=\"kp\">";
			if (!strstr($za_notpola,'lp')) $ret.="<td class=\"lp\">".($i)."</td>";
		...
		if (!strstr($za_notpola,'an')) $ret.="<td class=\"an\">".sysmsg("Gross","cart")."</td>";
