<?
	...
	$osoby_fields[]=array(sysmsg('th_zip','system'),"su_kod_pocztowy","address",10); // zmiana 4 na 10
	...
	$osoby_fields_grupy["wyr"]="Wyró¿niki";

	$osoby_fields_validate["su_nazwisko"]=array(1,1,80);
	$osoby_fields_validate["su_imiona"]=array(1,1,50);
	$osoby_fields_validate["su_kod_pocztowy"]=array(1,10,10); // zmiana 6 na 10
