...
//    alert("Has³o nie zgodne z potwierdzeniem. Prosze poprawiæ.");
    obj1.focus();
    return true;
  }
  return false;
...
function czyStareHasloOK(obj1,obj2)
{
  ...
  if (obj1.value!=obj2.value) {
    alert("Proszê wpisaæ poprawnie dotychczasowe has³o.");
    obj1.focus();
    return true;
  }
  return false;
...
if (min!=-1) {
  if (obj.value.length < min) {
    obj.focus();
    //alert("Za ma³o znaków, proszê wype³niæ pole. " +obj.name);
    return  true;
  }
  if (max!=-1) 
    if (obj.value.length > max) {
      obj.focus();
      //alert("Za du¿o znaków w polu: "+obj.name);
      return  true;
    }
}
else
...
if (min!=-1) {
  if (obj.value.length < min) {
    alert("Za ma³o znaków, proszê poprawnie wype³niæ pole. ");
    obj.focus();
    return  true;
  }
  if (max!=-1) 
    if (obj.value.length > max) {
      alert("Za du¿o znaków, proszê poprawnie wype³niæ pole ");
      obj.focus();
      return  true;
    }
}
...
var text, znak, ERR;
  ...
  if (ERR) {
   alert("W tym polu nale¿y wpisac liczbê ca³kowit¹");
   obj.focus();
   return ERR;
  }
if (min!=-1) {
...
var text, znak, ERR;
  ...
  if (isNaN(liczba)) ERR=1;
  if (ERR) {
   alert("W tym polu nale¿y wpisac liczbê zmiennoprzecinkow¹ z kropk¹.");
   obj.focus();
   return ERR;
  }
if (min!=-1) {
