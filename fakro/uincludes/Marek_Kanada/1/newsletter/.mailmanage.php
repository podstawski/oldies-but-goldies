...
<tbody>
<tr><td>Aby dodać nową wiadomość do wysyłki naciśnij poniższy przycisk</td></tr>
</tbody>
<tfoot>
<tr><td>
...
<tbody>
<tr><td colspan="2">Aby dodać grupę wpisz jej nazwę w polu "grupa" i naciśnij przycisk "Aktualizuj".<br>
	Jeżeli chcesz dodać użytkowników do istniejącej grupy wpisz jej nazwę do pola grupa a z polu "Adresy użytkowników" wpisz listę nowych adresów, każdy adres od nowej linii.</td></tr>
<tr><td align="right">grupa:</td><td><input name="mail_group" value="<?echo $mail_group?>"> </td></tr>
<tr><td colspan="2">
	Adresy użytkowników:<br>
