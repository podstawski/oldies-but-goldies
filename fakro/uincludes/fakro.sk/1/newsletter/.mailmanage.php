...
<tbody>
<tr><td>Aby dodaæ now± wiadomo¶æ do wysy³ki naci¶nij poni¿szy przycisk</td></tr>
</tbody>
<tfoot>
<tr><td>
...
<tbody>
<tr><td colspan="2">Aby dodaæ grupê wpisz jej nazwê w polu "grupa" i naci¶nij przycisk "Aktualizuj".<br>
	Je¿eli chcesz dodaæ u¿ytkowników do istniej±cej grupy wpisz jej nazwê do pola grupa a z polu "Adresy u¿ytkowników" wpisz listê nowych adresów, ka¿dy adres od nowej linii.</td></tr>
<tr><td align="right">grupa:</td><td><input name="mail_group" value="<?echo $mail_group?>"> </td></tr>
<tr><td colspan="2">
	Adresy u¿ytkowników:<br>
