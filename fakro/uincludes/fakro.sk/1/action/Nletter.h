...
//				echo $sql;
				...
				mail($mailto,$subject,"Aby potwierdziæ chêæ zapisania siê do newsletera lenalighting.pl kliknij na ten $link",$headers);

			} 
			else 
			{				
				$error = "Podany email jest ju¿ w naszej bazie !";
			}
...
//			echo $sql;
			...
			{			
				...
				$mailto = $NLFRONT[adres_email];
				mail($mailto,$subject,"Aby potwierdziæ chêæ wypisania siê z newsletera lenalighting.pl kliknij na ten $link",$headers);
			}
