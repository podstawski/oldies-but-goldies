...
//	$qs = ereg_replace("\+ ","\+",$qs);
	...
	for ($i=0; $i < $result->RecordCount(); $i++)
	{
		...
		<A HREF=\"$next${next_char}list[id]=$to_id&".sort_navi_qs($LIST)."\"><img src=\"$UIMAGES/autoryzacja/i_tree_n.gif\" hspace=5 vspace=0 border=0 style=\"cursor:hand\" alt=\"zmiana cen i innych parametrów związanych z handlem\"></A>
		";
