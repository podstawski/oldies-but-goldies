...
*/
	...
	{
		$usun = "<img src=\"$UIMAGES/autoryzacja/i_nie.gif\" alt=\"Usuń adres\" onClick=\"usunAdres($i)\">";
		$maile_tab.= "
	...
	{
		$usun = "<img src=\"$UIMAGES/autoryzacja/i_nie.gif\" alt=\"Usuń region\" onClick=\"usunRegion($i)\">";
		$regiony_tab.= "
		<FORM METHOD=POST ACTION=\"$self\">
		<INPUT TYPE=\"hidden\" name=\"do_action\" value=\"1\">
		<TR>
...
<script>
	...
	{
		if (!confirm('Na pewno usunąć ten region ?')) return;
