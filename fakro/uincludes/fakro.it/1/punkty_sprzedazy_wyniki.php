...
//	$fakrodb->debug=1;
	$sql = "SELECT * FROM punkty_sprzedazy WHERE ps_typ='S' $cond ORDER BY ps_miasto, ps_nazwa";
	...
	if (!$res->RecordCount())
	{
		...
		echo "Brak punktów sprzeda¿y spe³niaj±cych podane kryteria. $addinfo";
		return;
	}

	$pic = "<img valign=\"absmiddle\" title=\"Punkt sprzeda¿y posiada okna ekspozycyjne\" alt=\"Sklep posiada okno ekspozycyjne\" src=\"$UIMAGES/sb/check.gif\">";
