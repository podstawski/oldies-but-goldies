...
<tr>
	<td align="right">wielko¶æ domu </td>
	<td>
	<select name="form[pu]">
		...
		<option value="3" '.((htmlspecialchars($form[pu])==3)?"selected":"").'>Powy¿ej 150 m2</option>
	</select>
	</td>
</tr>
<!---
...
if($form[view] == 1) {
	...
	<tr>
		<td align="right"><strong>Powierzchnia u¿ytkowa:</strong></td>
	...
	<tr>
		<td align="right"><strong>K±t nachylenia dachu:</strong></td>
		<td>'.$projekt_k_nachylenia.' &ordm;</td>
	</tr>
	<tr>
		<td align="right"><strong>Wysoko¶æ budynku:</strong></td>
		<td>'.$projekt_w_budynku.' m<sup>2</sup></td>
	</tr>
	<tr>
		<td align="right"><strong>Minimalne wymiary dzia³ki:</strong></td>
		<td>'.$projekt_p_dzialki.' m<sup>2</sup></td>
	</tr>
	<!---  --->
	<tr>
		<td align="right"><strong>¦ciany:</strong></td>
	...
	<tr>
		<td align="right"><strong>Gara¿:</strong></td>
