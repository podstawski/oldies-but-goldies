...
function inform(id)
{
	...
	alert('Pole "' + strip(text) + '" nie mo¿e byæ puste!');
	el(id).focus();
	return false;
}
...
function inform_date(id, not_empty)
{
	...
	if (not_empty == true)
		alert('Pole "' + strip(text) + '" nie mo¿e byæ puste i musi zawieraæ datê w prawid³owym formacie!');
	else
		alert('Pole "' + strip(text) + '" musi zawieraæ datê w prawid³owym formacie!');
...
function inform_number(id, suffix, not_empty)
{
	...
	if (not_empty == true)
		alert('Pole "' + strip(text) + '" nie mo¿e byæ puste i mo¿e zawieraæ tylko liczby!');
	else
		alert('Pole "' + strip(text) + '" mo¿e zawieraæ tylko liczby!');
