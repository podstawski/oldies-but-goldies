...
//				echo $sql;
				...
				mail($mailto,$subject,"Aby potwierdzić chęć zapisania się do newsletera lenalighting.pl kliknij na ten $link",$headers);

			} 
			else 
			{				
				$error = "Podany email jest już w naszej bazie !";
			}
...
//			echo $sql;
			...
			{			
				...
				$mailto = $NLFRONT[adres_email];
				mail($mailto,$subject,"Aby potwierdzić chęć wypisania się z newsletera lenalighting.pl kliknij na ten $link",$headers);
			}
