...
<? if($errors!='') echo '<div align="center"><strong><font style="color:#ff0000;">Bitte füllen Sie die Felder in rot markiert!</font></div></strong><br>'; ?>

<br>

<?
$dzial_kontakt = array("organisator","webmaster");
?>
<table width="100%" border="0" cellspacing="3" cellpadding="3">
<form action="<?=$self;?>" method="post">
<tr>
	<td align="right">Wähle den Nachrichtenempfänger :</td>
...
<tr>
	<td align="right"><font style="color: #<?=$tematf;?>">Thema der Nachricht :</font></td>
...
<tr>
	<td align="right">BEMERKUNGEN - KOMMENTARE - FRAGEN :</td>
	<td colspan="2"><textarea name="form[uwagi]" cols="58" rows="5" class="input_pole"><? echo $form['uwagi']; ?></textarea></td>
</tr>
<tr>
	<td>&nbsp;</td>
	<td colspan="2"><input type="submit" name="poczta" value="Sende" class="submit"></td>
</tr>
</form>
</table>
...
<table width="100%" border="0" cellspacing="3" cellpadding="3">
<tr>
	<td colspan="2" align="center"><br><br><strong>E-mail wurde geschickt.<br>Vielen Dank.</strong></td>
</tr>
</table>
<br><br><br>
<?
