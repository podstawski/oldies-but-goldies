...
<? if($errors!='') echo '<div align="center"><strong><font style="color:#ff0000;">Kérem, töltse ki a pirossal jelölt mezőket!</font></div></strong><br>'; ?>

<br>

<?
$dzial_kontakt = array("szervező","webmester");
?>
<table width="100%" border="0" cellspacing="3" cellpadding="3">
<form action="<?=$self;?>" method="post">
<tr>
	<td align="right">válasszon címzettet :</td>
...
<tr>
	<td align="right"><font style="color: #<?=$tematf;?>">Üzenet tárgya :</font></td>
...
<tr>
	<td>&nbsp;</td>
	<td colspan="2"><input type="submit" name="poczta" value="Elküld" class="submit"></td>
</tr>
</form>
</table>
...
<table width="100%" border="0" cellspacing="3" cellpadding="3">
<tr>
	<td colspan="2" align="center"><br><br><strong>LEVELÉT ELKÜLDTÜK<br>Köszönjük!</strong></td>
</tr>
</table>
<br><br><br>
<?
