...
<? if($errors!='') echo '<div align="center"><strong><font style="color:#ff0000;">Please fill in the fields marked red!</font></div></strong><br>'; ?>

<br>

<?
$dzial_kontakt = array("organizer","webmaster");
?>
<table width="100%" border="0" cellspacing="3" cellpadding="3">
<form action="<?=$self;?>" method="post">
<tr>
	<td align="right">choose the recipient :</td>
...
<tr>
	<td align="right"><font style="color: #<?=$tematf;?>">Subject  :</font></td>
	<td colspan="2"><input type="text" name="form[temat]" value="<? echo $form['temat'];?>" size="30" maxlength="70" class="input_pole"></td>
</tr>
<tr>
	<td align="right"><font style="color: #<?=$imief;?>">Firs name :</font></td>
...
<tr>
	<td align="right">NOTES - COMMENTS - QUESTIONS :</td>
	<td colspan="2"><textarea name="form[uwagi]" cols="58" rows="5" class="input_pole"><? echo $form['uwagi']; ?></textarea></td>
</tr>
<tr>
	<td>&nbsp;</td>
	<td colspan="2"><input type="submit" name="poczta" value="Send" class="submit"></td>
</tr>
</form>
</table>
...
<table width="100%" border="0" cellspacing="3" cellpadding="3">
<tr>
	<td colspan="2" align="center"><br><br><strong>The mail has been sent.<br>Thank you.</strong></td>
</tr>
</table>
<br><br><br>
<?
