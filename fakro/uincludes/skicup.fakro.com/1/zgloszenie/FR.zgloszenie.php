...
<tr>
	...
	<dd>Désolé mais la liste des IFD WORLD CUP SKI FAKRO est fermée.
	Nous vous remercions pour votre intéret.</dd></div>
	<br> <div align="right">Organisateurs</div></td>
</tr>
</table>
<?
	}else{
...
$_stowarzyszenie = array('Autriche','Belgique','Suisse','République Tchèque','Allemagne','France','Royaume-Uni','Hongrie','Croatie','Irlande','Luxembourg','Lettonie','Pays-Bas','Pologne','Russie','Slovaquie','Slovénie');
...
<br>
<? if($error_nip == 1) 	echo '<div align="center"><strong><font style="color:#ff0000;">Désolé, la limite de participants de votre société est dépassé. Base: Reglement n o Article I. 4,5</font></div></strong><br>'; ?>
<? if($errors!='' && $error_nip != 1) echo '<div align="center"><strong><font style="color:#ff0000;">Merci pour remplir les cases marqués en rouge!</font></div></strong><br>';?>
<br>
...
<tr>
	<td align="right"><font style="color: #<?=$imief;?>">PRENOM</font></td>
...
<?php /*
<tr>
	<td align="right"><font style="color: #<?=$stowarzyszenief;?>">REPRESENTANT DE L'ASSOCIATION  (choisir dans la liste - associations nationales)</font></td>
	<td colspan="2">
...
<tr>
	<td align="right"><font style="color: #<?=$emailf;?>">ADRESSE E-MAIL</font></td>
	<td colspan="2"><input type="Text" name="form[email]" size="50" maxlength="70" value="<? echo $form['email'];?>" class="input_pole"></td>
</tr>
<tr>
	<td align="right"><font style="color: #<?=$nipf;?>">NUMERO SIRET (seulement pour les membres de l'UE)</font></td>
	<td colspan="2"><input type="Text" name="form[nip]" size="50" maxlength="70" value="<? echo $form['nip'];?>" class="input_pole"></td>
</tr>
<tr>
	<td align="right"><font style="color: #<?=$osoba_towarzyszacaf;?>">ACCOMPAGNE DE</font></td>
	<td colspan="2">
	<input type="radio" name="form[osoba_towarzyszaca]" value="tak" <? if($form['osoba_towarzyszaca'] == "tak") {?>checked<?}?>> OUI
	<br>
	<input type="radio" name="form[osoba_towarzyszaca]" value="nie" <? if($form['osoba_towarzyszaca'] == "nie") {?>checked<?}?>> NON
	</td>
</tr>
<tr>
...
<tr>
	<td align="right"><font style="color: #<?=$hotelf;?>">RESERVATION D'HOTEL (Hôtel "Activa"):</font></td>
	<td colspan="2">
	<input type="radio" name="form[hotel]" value="POKOJ 1-OSOBOWY" <? if($form['hotel'] == "POKOJ 1-OSOBOWY") {?>checked<?}?>> CHAMBRE 1-PERSONNE
	<br>
	<input type="radio" name="form[hotel]" value="POKOJ 2-OSOBOWY" <? if($form['hotel'] == "POKOJ 2-OSOBOWY") {?>checked<?}?>> CHAMBRE 2-PERSONNES
	</td>
</tr>
<tr>
	<td align="right"><font style="color: #<?=$wypozyczenie_sprzetuf;?>">Je voudrais louer du l'équipement sportif sur place</font></td>
	<td colspan="2">
	<input type="radio" name="form[wypozyczenie_sprzetu]" value="tak" <? if($form['wypozyczenie_sprzetu'] == "tak") {?>checked<?}?>> OUI
	<br>
	<input type="radio" name="form[wypozyczenie_sprzetu]" value="nie" <? if($form['wypozyczenie_sprzetu'] == "nie") {?>checked<?}?>> NON
	</td>
</tr>
<tr>
	<td colspan="3"><br></td>
...
<tr>
	<td align="right"><font style="color: #<?=$transportf;?>">Moyens de transport:</font></td>
	<td colspan="2">
	<input type="radio" name="form[transport]" value="transport zorganizowany" <? if($form['transport'] == "transport zorganizowany") {?>checked<?}?>> vol &agrave; Cracovie (l'aéroport "Balice") et puis le transport &agrave; Muszyna assuré par organisateur
	<br><br>
	<input type="radio" name="form[transport]" value="transport wlasny" <? if($form['transport'] == "transport wlasny") {?>checked<?}?>> propre transport
	</td>
</tr>
</table>
...
<tr>
	...
	<td><div align="justify"><font style="color: #<?=$oswiadczenief;?>">Je déclare de m'informer du reglement de l'IFD FAKRO WORLD CUP SKI.</font></div></td>
</tr>
</table>
<table width="550" border="0" cellspacing="3" cellpadding="3">
<tr>
	<td width="200"></td>
	<td width="350"><input type="submit" name="poczta" value="Envoyer le message" class="submit"></td>
</tr>
</form>
</table>
...
<table width="100%" border="0" cellspacing="3" cellpadding="3">
<tr>
	<td colspan="2" align="center"><br><br><strong><font style="color:#ff0000;">Erreur du serveur.<br>L'application n'a pas été envoyée!</font></strong></td>
</tr>
</table>
<br><br><br>
<?
