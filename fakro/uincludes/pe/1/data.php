...
SWITCH ($weekday)
{
	CASE 'Monday': 		if ($lang=="p" || $lang=="i") $weekday="poniedzia³ek";	BREAK;
	...
	CASE 'Friday': 		if ($lang=="p" || $lang=="i") $weekday="pi¹tek"; 		BREAK;
...
SWITCH ($month)
{
	CASE '1':	if ($lang=="p" || $lang=="i") $month="styczeñ";  else $month="january";		BREAK;
	CASE '2': 	if ($lang=="p" || $lang=="i") $month="luty"; else $month="february";		BREAK;
	CASE '3': 	if ($lang=="p" || $lang=="i") $month="marzec"; else $month="march"; 		BREAK;
	CASE '4': 	if ($lang=="p" || $lang=="i") $month="kwiecieñ"; else $month="april"; 		BREAK;
	...
	CASE '8':	if ($lang=="p" || $lang=="i") $month="sierpieñ"; else $month="august";		BREAK;
	CASE '9': 	if ($lang=="p" || $lang=="i") $month="wrzesieñ"; else $month="september";	BREAK;
	...
	CASE '12':	if ($lang=="p" || $lang=="i") $month="grudzieñ"; else $month="december";	BREAK;
}
