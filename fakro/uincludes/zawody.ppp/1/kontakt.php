...
<? if($errors!='') echo '<div align="center"><strong><font style="color:#ff0000;">Proszę wypełnić pola oznaczone na czerwono!</font></div></strong><br>'; ?>
...
<tr>
	<td align="right">wybierz odbiorcę wiadomości :</td>
...
<tr>
	<td align="right"><font style="color: #<?=$tematf;?>">Temat wiadomości :</font></td>
...
<tr>
	<td>&nbsp;</td>
	<td colspan="2"><input type="submit" name="poczta" value="Wyślij wiadomość" class="submit"></td>
</tr>
</form>
</table>
...
<?
	...
	$tresc_mail_firma .= "wyslał(a) wiadomość ze strony ppp.pomysloprzyszlosci.org: \n\n\n";
	$tresc_mail_firma .= "temat: ".$form[temat]."\n";
	$tresc_mail_firma .= "uwagi: \n".$form[uwagi];
	
	$idb->sqlaction('insert','zawody_poczta_ppp','',
...
$header['Subject'] = "wiadomość ze strony ppp.pomysloprzyszlosci.org - mail ".date("Y-m-d H:i:s", time());
...
<table width="100%" border="0" cellspacing="3" cellpadding="3">
<tr>
	<td colspan="2" align="center"><br><br><strong>POCZTA ZOSTAŁA WYSŁANA<br>Dziękujemy</strong></td>
</tr>
</table>
<br><br><br>
<?
