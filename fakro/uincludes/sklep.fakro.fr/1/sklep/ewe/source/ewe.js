...
EWE.prototype.loadEWE = function(){
 ...
 //content elements
  ...
  document.all.tlbTable.appendChild(ne);
  ...
  ne.style.left = '-3px';
  ne.style.styleFloat = 'none';
  ne.style.paddingTop = '3px';
  ne.style.paddingLeft = '5px';
  container.appendChild(ne);
  ...
  ne.className = 'footer';
  ne.style.styleFloat = 'left';
  container.all.tlbMisc.appendChild(ne);
  ...
  ne.style.width = '500px';
  ne.style.height = '290px';
