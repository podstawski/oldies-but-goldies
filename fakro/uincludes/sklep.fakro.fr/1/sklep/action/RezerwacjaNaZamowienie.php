<?
	...
	$sql = "INSERT INTO zamowienia (za_su_id,za_numer,za_numer_obcy,za_uwagi,za_status,za_data,za_adres,za_parametry,za_sk_id,za_osoba,za_data_status)
			VALUES (".$AUTH[parent].",$maxnumer,'".$FORM[order_number]."','".$FORM[uwagi]."',0,$NOW,'".$FORM[dostawa]."','$pram_string',$SKLEP_ID,$AUTH[id],$NOW);
