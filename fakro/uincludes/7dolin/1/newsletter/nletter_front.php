<?
		...
		$zap = array("i"=>"zapisz","f"=>"noter","d"=>"einschreiben","r"=>"×aß'ŘcëŇaâě","e"=>"sign up");
		$wyp = array("i"=>"wypisz","f"=>"écrire","d"=>"ausschreiben","r"=>"ŘáÚŰîç'Řâě","e"=>"sign out");
		$zapisz = $zap[$lang];
		$wypisz = $wyp[$lang];
		...
		";
//	}	
	$c1 = "Proszę podać adres email";
	$c2 = "Proszę podać prawidłowy adres email";
