<?
	...
	<col class=\"cn\">
	<thead>
	<TR><TD colspan=\"2\">Parametry użytkownika</TD></TR>
	</thead>
	<tbody>
	<TR>
	...
	<TR>
		<TD align=\"right\">ID CRM:</TD>
		<TD><INPUT TYPE=\"text\" NAME=\"AUSER[su_id_crm]\" class=\"ilong\" value=\"$su_id_crm\"></TD>
	</TR>
	
<!---
	<TR>
		<TD valign=\"top\" align=\"right\">Dozwolone adresy IP<br>(oddzienane przecinkami):</TD>
