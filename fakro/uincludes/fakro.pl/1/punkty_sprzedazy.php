...
<?
	...
	<form id=\"search_form\" method=$method action=\"$self\">
	<TR>
	...
	<TR>
		<TD>
		<p onClick=\"document.getElementById('search_form').submit()\" style=\"cursor:pointer;font-weight: bold;\">Wyszukaj&nbsp;&nbsp;<img src=\"$IMAGES/h1.gif\" align=\"absmiddle\"></p>
		</TD>
	</TR>
	</FORM>
	</TABLE>
