...
if($KAMELEON_MODE!=0) {
	echo '<br/><br/><br/>';
	echo '<div align="center"><font color="#ff0000"><strong>Ten moduł może być uruchomiony tylko na wersji opublikowanej.</strong></font></div>';
	echo '<br/><br/><br/>';
	exit;
}
...
<?php /* <script type="text/javascript" src="<? echo $_path; ?>js/jquery-1.3.2.js"></script> */ ?>
...
$(function(){
	$('#swfupload-control').swfupload({
		...
		button_image_url : "<? echo $_path; ?>js/swfupload/wdp_buttons_upload_114x29.png",
		button_width : 114,
		button_height : 29,
		...
		.bind('fileQueueError', function(event, file, errorCode, message){
			alert('Problem z przesłaniem pliku.');
		})
...
$form->_jsPrefix = 'Błąd w formularzu:';
$form->_jsPostfix = 'Popraw formularz i spróbuj ponownie.';
...
$form->addRule('firma','Proszę wpisać: Nazwę firmy','required', null, 'client');

$form->addElement('text','nazwisko','Imię i nazwisko',array('size'=>50,'maxlength'=>50));
$form->addRule('nazwisko','Proszę wpisać: Imię i nazwisko','required', null, 'client');

$form->addElement('text','ulica','Ulica',array('size'=>50,'maxlength'=>50));
$form->addRule('ulica','Proszę wpisać: Ulicę','required', null, 'client');

$form->addElement('text','nr_budynku','Nr budynku',array('size'=>10,'maxlength'=>10));
$form->addRule('nr_budynku','Proszę wpisać: Nr budynku','required', null, 'client');
...
$form->addRule('kod','Proszę wpisać: Kod pocztowy','required', null, 'client');

$form->addElement('text','miejscowosc','Miejscowość',array('size'=>50,'maxlength'=>50));
$form->addRule('miejscowosc','Proszę wpisać: Miejscowość','required', null, 'client');

$form->addElement('text','kraj','Kraj',array('size'=>50,'maxlength'=>50));
$form->addRule('kraj','Proszę wpisać: Kraj','required', null, 'client');

$form->addElement('text','telefon','Numer telefonu',array('size'=>50,'maxlength'=>50));
$form->addRule('telefon','Proszę wpisać: Numer telefonu','required', null, 'client');

$form->addElement('text','email','E-mail',array('size'=>50,'maxlength'=>50));
$form->addRule('email','Proszę wpisaa: E-mail','required', null, 'client');
$form->addRule('email','Nieprawidłowy: E-mail.','email', null, 'client');
...
$form->addRule('nr_tabl_znamionowej','Proszę wpisać: Numer tabl. znamionowej','required', null, 'client');

$form->addElement('text','data_nabycia','Data nabycia produktu',array('size'=>10,'maxlength'=>50));
$form->addRule('data_nabycia','Proszę wpisać: Datę nabycia produktu','required', null, 'client');
...
$form->addElement('text','ilosc','Ilość',array('size'=>10,'maxlength'=>10));
$form->addRule('ilosc','Proszę wpisać: Ilość','required', null, 'client');

$form->addElement('textarea','przedmiot_uslugi','Przedmiot usługi (opis)',array('rows'=>4,'cols'=>52));

$form->addElement('checkbox','zgoda','','Wyrażam zgodę na przetwarzanie moich danych osobowych zawartych w tym formularzu przez FAKRO Sp. z o.o. z siedzibę w Nowym Sączu przy ul. Węgierskiej 144A, zgodnie z Ustawę z dn. 29.08.1997 (Dz.U. 1997r., nr 133, poz.883 wraz z póżniejszymi zmianami) o ochronie danych osobowych.');
$form->addRule('zgoda','Proszę zaznaczyć zgodę na przetwarzanie danych osobowych.','required', null, 'client');

// info o wymaganych polach
$form->setRequiredNote('<font color="red">*</font> - wymagane pola oznaczone sš gwiazdkš');

$form->setRequiredNote('<div id="swfupload-control"><p>można dodać 5 plików graficznych, każdy o maksymalnej wielkości 1 MB</p><input type="button" id="button" /><p id="queuestatus" ></p><ol id="log"></ol></div>');

$grp_grpSubmitReset[] = &HTML_QuickForm::createElement('submit','btnSubmit','wyślij');
