<?
		...
		$zap = array("i"=>"zapisz","f"=>"noter","d"=>"einschreiben","r"=>"×aß'ØcëÒaâì","e"=>"sign up");
		$wyp = array("i"=>"wypisz","f"=>"écrire","d"=>"ausschreiben","r"=>"ØáÚÛîç'Øâì","e"=>"sign out");
		$zapisz = $zap[$lang];
		$wypisz = $wyp[$lang];
		...
		";
//	}	
	$c1 = "Proszê podaæ adres email";
	$c2 = "Proszê podaæ prawid³owy adres email";
