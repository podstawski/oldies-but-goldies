    ...
    statics :
    {
        ...
        __lang :
        {
            "pl" :
            {
                ...
                "calendar.menu.btnBackMainMenu" : "Powrót do menu głównego",
                "calendar.menu.btnAddEvent"     : "Dodaj wydarzenie",
                "calendar.menu.btnAddRoom"      : "Dodaj pomieszczenie",
                "calendar.menu.btnAddCoach"     : "Dodaj trenera",
                ...
                "surveys.type.created"         : "Utworzona",
        ...
        calendar :
        {
            pl :
            {
                date:
                {
                    ...
                    day_short:["Pon", "Wt", "Śr", "Czw", "Pt", "Sb", "Nd"]
                },
                labels:
                {
