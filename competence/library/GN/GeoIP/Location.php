...
/**
 * This class represents a location record as returned by GN_GeoIP::lookupLocation().
 *
 ...
 * @link     http://pear.php.net/package/GN_GeoIp
 * @see      GN_GeoIP::lookupLocation()
 */
class GN_GeoIP_Location implements Serializable
{
     ...
     *
     * @param GN_GeoIP_Location $loc The other point to which distance will be calculated.
     *
     * @return float The number of km between two points on the globe.
     */
    public function distance(GN_GeoIP_Location $loc)
    {
