	 ...
	 $.validationEngineLanguage = {
		  newLang: function(){
				$.validationEngineLanguage.allRules = {
					...
					'custom_date': {
						'regex': /^\d{4}[\/\-](0?[1-9]|1[012])[\/\-](0?[1-9]|[12][0-9]|3[01])\ \d{2}\:\d{2}\:\d{2}$/,
						'alertText': '* Data musi być podana w postaci RRRR-MM-DD GG:MM:SS'
					},				
					'custom_number': {
						'regex': /^([2-9]|[1][0])$/,
						'alertText': '* Proszę podać cyfrę od 2 do 10'
					}
				};
