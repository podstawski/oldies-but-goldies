...
class GN_Gapps
{
    ...
    public static function logout($redirect = '', $email = '', $platform_link = '', $platform_hash = '', $googleLogout = false)
    {
        if ($platform_link && $platform_hash && $email) {
        ...
        if ($googleLogout) {
            // nie dziala tylko dla jednej domeny
            // $url = $domain ? 'https://mail.google.com/a/' . $domain . '/?logout' : 'https://www.google.com/accounts/Logout';
        ...
        if ($redirect) {
            ...
            exit;
            // wiocha...
            die('<script type="text/javascript">location.href = \'' . $redirect . '\';</script>');
        }
    }
